...
const PayBy = () => {
  return (
    <div className={classes.payByArea}>
      ...
      <div className={classes.paymentD}>
        <img
          src="https://img.pay.naver.net/static/images/customer/og/naverpay.png"
          alt="naverpay"
        />
        <div>네이버페이</div>
      </div>
      <div className={classes.paymentD}>
        <img
          src="https://image.toast.com/aaaaac/paycoNoti/payco_com.jpg"
          alt="payco"
        />
        <div>페이코</div>
      </div>
      <div className={classes.paymentD}>
        <img
          src="https://play-lh.googleusercontent.com/W607uSRreW4h6Ar4reYPYCtYXID0_AIsd9m2fgWwdAN7JyZGG3WVM782wa5CfCvKZVM"
          alt="toss"
        />
        <div>토스</div>
      </div>
