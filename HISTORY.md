...
1. 비밀번호 변경 퍼블리싱 수정 & API 연동 완료
2. 마켓 상세 바로 구매 API 연동
3. 커뮤니티 상세 좋아요 등록 API 연동 (취소는 수정 예정)

### 2022.03.27. 차주희

1. 커뮤니티 상세 댓글 추가 및 불러오기 API 연동 완료
2. 커뮤니티 상세 수정 파라미터 연결
3. 커뮤니티 상세 삭제 API 연동 완료
4. 커뮤니티 상세 및 마켓 상세 폴더 구조 정리
5. 마켓 상세 장바구니 추가 API 연동 완료
...
1. 나의쇼핑 (accountMyShopping)
   - 주문상품 리스트 UI 수정
   - 구매확정 팝업 생성
   - 배송상태에 따라 “리뷰작성” 버튼 활성화
2. 팔로잉, 팔로워 목록 페이지
   - 마이페이지 팔로잉 목록 페이지, 마이페이지 팔로워 목록 페이지 생성
   - 팔로우, 언팔로우 state관리 및 back 연결
   - 팔로워 삭제 기능 추가
3. 선물하기 팝업 생성
   - 선물할 계정 결제페이지로 전달
